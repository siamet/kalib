...
│   │   ├── led_driver.py       # Unused: illumination is manual here
...
- **LEDDriver**: Serial-based LED control. Not used on this instrument, where
  illumination is manual and not software-controllable.
